...
Original file is located at
    https://colab.research.google.com/drive/1rKRa8_2tIOYnEYRRZYfojO0kXaslzaK2
...
PATH = "/content/drive/MyDrive/Colab_Notebooks/dtsa5800/"
...
def match_tweet(tweet, country_codes=None, start_date=None, end_date=None):
    ...
    if country_codes:
      for i in range(len(country_codes)):
        country_codes[i] = country_codes[i].lower()
...
with gzip.open(PATH + 'data/nikelululemonadidas_tweets.jsonl.gz') as f:

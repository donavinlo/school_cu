...
Original file is located at
    https://colab.research.google.com/drive/1oY6__fILUdGkWLTrY3Y1Tq-igkICtv30
...
with gzip.open("/content/drive/MyDrive/Colab_Notebooks/dtsa5799/data/Jewelry.jsonl.gz") as products:
...
all_texts = []
with gzip.open("/content/drive/MyDrive/Colab_Notebooks/dtsa5799/data/Jewelry.json.gz") as reviews:

---
title: "Week 3 Notes: Discrete Random Variables"
author: "D. ODay"
date: "10/21/2021"
output: pdf_document
---
...
```{r geometric}
# For first success, use the geomertic function but make x one less since the geometric distribution 
# doesn't include the sucessful trial
#X ~ Geom(.05). Want to find 4 failures before finding success
dgeom(4, 0.05)
```
...
dnbinom(3, 9, 0.5)
#dnbinom(x, r, prob)
# x is the number of failures, r is the number of sucesses wanted

...
Original file is located at
    https://colab.research.google.com/drive/1x9KDAkjyLHb7nCH34y0Ei5H9XasqCh_P
...
def read_json(filename, lines=False):
    ...
    1. Check if the file is a gzipped file by checking for a ".gz" file name
       extension, and handle the file accordingly.
    2. If the file is not gzipped, assume that it is either a valid json or
       json-l file.
    3. Process the file as json-l if lines=True, otherwise process it as json.
    """
    pass
...
sara = "drive/MyDrive/News_Category_Dataset_v2.json.gz"
sara[-3:] == '.gz'
